    ...
    for vpc_id in vpc_ids:
        try:
            ...
            acct_b = sts_connection.assume_role(
                RoleArn="arn:aws:iam::222222222222:role/role-on-source-account", RoleSessionName="cross_acct_lambda"
            )
...
def deauthorize_vpc_to_hosted_zone(vpc_ids, phz_id):
    for vpc_id in vpc_ids:
        try:
            ...
            logger.error("Error deleting authorization %s to hosted zone %s : %s", vpc_id, phz_id, ex, exc_info=True)
