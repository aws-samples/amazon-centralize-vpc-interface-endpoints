...
def handler(event, context):
    ...
    if request_type == 'Create': return associate_vpc_to_hosted_zone(vpc_id, phz_id,account_id)
    if request_type == 'Update': return associate_vpc_to_hosted_zone(vpc_id, phz_id,account_id)
